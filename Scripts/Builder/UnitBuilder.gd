...
static func _select_scene(name:String):
	match name:
		"Pikachu":
			return preload("res://Scenes/pikachu.tscn")
		"Charmander":
			return preload("res://Scenes/charmander.tscn")
		"bulbasaur":
			return preload("res://Scenes/bulbasaur.tscn")
		"Squirtle":
			return preload("res://Scenes/squirtle.tscn")
